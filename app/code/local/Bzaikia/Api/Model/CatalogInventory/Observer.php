 ...
 */
class Bzaikia_Api_Model_CatalogInventory_Observer extends Mage_CatalogInventory_Model_Observer
{
    /**
        ...
        if ($stockItem) {
            if (!$stockItem->getIsInStock() || ($parentStockItem && !$parentStockItem->getIsInStock())) {
                $quoteItem->addErrorInfo(
                    ...
                    Mage::helper('cataloginventory')->__('Product %s is currently out of stock.', $quoteItem->getProduct()->getSku())
                );
